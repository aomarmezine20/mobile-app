    ...
    var RateLimitMiddleware = _classThis = /** @class */ (function () {
        ...
        RateLimitMiddleware_1.prototype.use = function (req, res, next) {
            return __awaiter(this, void 0, void 0, function () {
                var ip, now, windowStart, currentRequests;
                var _this = this;
                return __generator(this, function (_a) {
                    ...
                    try {
                        ...
                        this.requestCounts.forEach(function (requests, key) {
                            _this.requestCounts.set(key, requests.filter(function (_a) {
                                var timestamp = _a[0];
                                return timestamp > windowStart;
                            }));
                        });
                        currentRequests = this.requestCounts.get(ip) || [];
