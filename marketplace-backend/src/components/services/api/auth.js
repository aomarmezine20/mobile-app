...
exports.authService = {
    login: function (credentials) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, index_1.apiService.post('/auth/login', credentials)];
                case 1:
                    response = _a.sent();
    ...
    register: function (userData) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, index_1.apiService.post('/auth/register', userData)];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response];
            }
    ...
    logout: function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, index_1.apiService.post('/auth/logout')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    refresh: function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, index_1.apiService.post('/auth/refresh')];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response];
            }
    ...
    forgotPassword: function (email) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, index_1.apiService.post('/auth/forgot-password', { email: email })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    resetPassword: function (token, newPassword) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, index_1.apiService.post('/auth/reset-password', { token: token, newPassword: newPassword })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
