...
var secureStorage_1 = require("../storage/secureStorage");
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.setupInterceptors = function () {
        var _this = this;
        // Request interceptor
        this.instance.interceptors.request.use(function (config) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, secureStorage_1.SecureStorage.getToken()];
                    case 1:
                        token = _a.sent();
                        if (token) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, secureStorage_1.SecureStorage.clear()];
                    case 1:
                        _b.sent();
                        _b.label = 2;
    ...
    ApiService.prototype.post = function (url, data, config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.instance.post(url, data, config)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
    ...
    ApiService.prototype.put = function (url, data, config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.instance.put(url, data, config)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
    ...
    ApiService.prototype.patch = function (url, data, config) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.instance.patch(url, data, config)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
