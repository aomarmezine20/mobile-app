...
var EditAddressScreen = function (_a) {
    var _b;
    var navigation = _a.navigation, route = _a.route;
    var addressId = (_b = route.params) === null || _b === void 0 ? void 0 : _b.addressId;
    ...
    return (<react_native_1.ScrollView style={styles.container}>
      <react_native_1.View style={styles.header}>
        <react_native_1.Text style={styles.title}>Edit Address</react_native_1.Text>
      </react_native_1.View>
...
exports.default = EditAddressScreen;
