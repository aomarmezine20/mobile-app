...
var ProductsService = function () {
    ...
    var ProductsService = _classThis = /** @class */ (function () {
        ...
        ProductsService_1.prototype.create = function (productData, supplierId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.product.create({
                            data: __assign(__assign({}, productData), { status: productData.status || 'available', supplier: {
        ...
        ProductsService_1.prototype.update = function (id, productData) {
            return __awaiter(this, void 0, void 0, function () {
                var product;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        ProductsService_1.prototype.findBySupplier = function (supplierId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.product.findMany({
                            where: {
        ...
        ProductsService_1.prototype.findByStatus = function (status) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.product.findMany({
                            where: {
        ...
        ProductsService_1.prototype.toggleStatus = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var product, newStatus;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.product.findUnique({
                                where: { id: id },
        ...
        ProductsService_1.prototype.searchProducts = function (query) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.product.findMany({
                            where: {
        ...
        ProductsService_1.prototype.getLowStockProducts = function () {
