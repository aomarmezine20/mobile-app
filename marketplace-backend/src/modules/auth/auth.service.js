...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.comparePasswords(password, user.password)];
                        case 2:
                            _a = (_b.sent());
                            _b.label = 3;
                        case 3:
        ...
        AuthService_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, user, payload;
        ...
        AuthService_1.prototype.register = function (registerDto) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, firstName, lastName, role, existingUser, hashedPassword, createdUser, payload;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            email = registerDto.email, password = registerDto.password, firstName = registerDto.firstName, lastName = registerDto.lastName, role = registerDto.role;
                        ...
                        case 3:
                            createdUser = _a.sent();
                            payload = { email: createdUser.email, sub: createdUser.id, role: createdUser.role };
                            return [2 /*return*/, {
                                    access_token: this.jwtService.sign(payload),
                                    user: createdUser,
                                }];
        ...
        AuthService_1.prototype.comparePasswords = function (password, hashedPassword) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
